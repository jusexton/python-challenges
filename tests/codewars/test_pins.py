...
from challenges.codewars import pins
...
@pytest.mark.parametrize('expected,observed', [
    ...
    (['339', '366', '399', '658', '636', '258', '268', '669', '668', '266', '369', '398', '256', '296', '259', '368',
      '638', '396',
      '238', '356', '659', '639', '666', '359', '336', '299', '338', '696', '269', '358', '656', '698', '699', '298',
      '236', '239'], '369')
])
def test_should_return_all_possible_pins_from_observed_pin_number(expected: List[str], observed: str):
