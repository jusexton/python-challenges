...
class TestPaginationHelper:
    ...
    def test_page_item_count_correctly_returns_how_many_items_are_on_a_page(self, helper, index, count):
        assert count == helper.page_item_count(index)

    @pytest.mark.parametrize("index,page", [
        (10, 2),
        (9, 1),
        (5, 1),
        (4, 0),
    ...
    def test_page_index_correctly_returns_which_page_an_index_belongs_too(self, helper, index, page):
